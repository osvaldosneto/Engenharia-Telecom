...
% Filtro BP IIR - Transformacao Bilinear
...
% Passa Baixa Prototipo Chebyshev Tipo I
[n, Wp] = cheb1ord(Op,Os,Ap,As,'s');
...
xlabel('Hz')
ylabel('Graus');
title('Fase do filtro IIR BP')

% Valores para as frequencias - Duvida
[h,w] = freqz(bzn,azn,[f1,f2,f3,f4]);
mag = 20*log10(abs(h));

% Polos de quais filtros - Duvida
